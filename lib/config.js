...
const twpConfig = (function () {
  ...
  const defaultConfig = {
    ...
    addPaddingToPage: "no",
    proxyServers: {},
    // TWP-FullPage patch: remembered source-language override per hostname.
    // Shape: { "example.com": "zh-CN", "wikipedia.org": "ja", ... }
    fpSourceLangByHost: {},
    // TWP-FullPage patch: floating translate bubble (Immersive-Translate style)
    fpShowFloatingBubble: "yes",
    fpBubblePos: null,
    // per-hostname override of bubble visibility: { "host": "yes"|"no" }.
    // Falls back to fpShowFloatingBubble when a host has no entry.
    fpBubbleByHost: {},
  };
